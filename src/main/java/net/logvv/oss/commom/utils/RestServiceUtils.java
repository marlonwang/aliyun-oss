...
import net.logvv.oss.commom.constant.AppConstant;
...
public final class RestServiceUtils
{
        ...
        throws RestInvocationException
    {
        ...
        try
        {
            StringBuffer sb = new StringBuffer(AppConstant.DEFAULT_STRINGBUFFER_LENGTH);
        ...
        throws RestInvocationException
    {
        ...
        StringBuffer urlTemplate = new StringBuffer(AppConstant.DEFAULT_STRINGBUFFER_LENGTH);
...
//    public static String doPostSenderMessage(String sendUrl, HttpEntity<String> httpEntity, MessageBody body)
//        throws RestInvocationException
//    {
//        try
//        {
//           return restTemplate.postForObject(sendUrl, httpEntity, String.class, body);
//        }
//        catch (RestClientException e)
//        {
//            throw new RestInvocationException("Failed to request get url: " + sendUrl, e);
//        }
//    }
}
